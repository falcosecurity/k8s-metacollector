...
func (r *DaemonsetCollector) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	var err error
	var ds = newPartialDaemonset
	...
	currentNodes, err := r.Nodes(ctx, logger, &ds.ObjectMeta)
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *DaemonsetCollector) Nodes(ctx context.Context, logger logr.Logger, meta *metav1.ObjectMeta) (fields.Nodes, error) {
	pods := corev1.PodList{}
