...
func (x *Fields) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *Fields) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
type Event struct {
	...
	Metadata *Fields     `protobuf:"bytes,2,opt,name=metadata,proto3" json:"metadata,omitempty"`
	Refs     *References `protobuf:"bytes,3,opt,name=refs,proto3,oneof" json:"refs,omitempty"`
}
...
func (x *Event) GetMetadata() *Fields {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_metadata_metadata_proto_rawDesc = []byte{
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xd1, 0x01, 0x0a, 0x06, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73,
	...
	0x6c, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x2e, 0x4c, 0x61, 0x62, 0x65, 0x6c,
	...
	,
...
var file_metadata_metadata_proto_goTypes = []interface{}{
	...
	(*Fields)(nil),        // 3: metadata.Fields
	(*Event)(nil),         // 4: metadata.Event
	nil,                   // 5: metadata.Selector.ResourceKindsEntry
	nil,                   // 6: metadata.References.RefsEntry
	nil,                   // 7: metadata.Fields.LabelsEntry
}
var file_metadata_metadata_proto_depIdxs = []int32{
	5, // 0: metadata.Selector.resourceKinds:type_name -> metadata.Selector.ResourceKindsEntry
	6, // 1: metadata.References.refs:type_name -> metadata.References.RefsEntry
	7, // 2: metadata.Fields.labels:type_name -> metadata.Fields.LabelsEntry
	3, // 3: metadata.Event.metadata:type_name -> metadata.Fields
	1, // 4: metadata.Event.refs:type_name -> metadata.References
	2, // 5: metadata.References.RefsEntry.value:type_name -> metadata.ListOfStrings
	0, // 6: metadata.Metadata.Watch:input_type -> metadata.Selector
	4, // 7: metadata.Metadata.Watch:output_type -> metadata.Event
...
func file_metadata_metadata_proto_init() {
	...
	file_metadata_metadata_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
